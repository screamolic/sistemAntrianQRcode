...
| ❌ Don't                                           | Details                                                                                           |
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| gotcha in AGENTS.md                                | File updated (external): AGENTS.md Content summary (8 lines): <!-- BEGIN:nextjs-agent-rules --> # |
...
| Environment variables: NEXT*PUBLIC* prefix for cli | Environment variables: NEXT*PUBLIC* prefix for client-side only                                   |
